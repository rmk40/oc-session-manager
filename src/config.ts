...
export const STALE_TIMEOUT_SEC =
  parseInt(process.env.OC_SESSION_TIMEOUT || "", 10) || 120;
export const STALE_TIMEOUT_MS = STALE_TIMEOUT_SEC * 1000;
export const LONG_RUNNING_MIN =
  parseInt(process.env.OC_SESSION_LONG_RUNNING || "", 10) || 10;
